...
sudo mkdir /var/lib/tomcat10/webapps/ROOT/static/ && \
sudo rm -rf /var/lib/tomcat10/webapps/ROOT/static/* && \
sudo cp -r /home/dev/Documents/commander/frontend/* /var/lib/tomcat10/webapps/ROOT/static/
